function animate_pendulum_cart(t, q1, q2,params, varargin)
...
%   x_pendulum = q1 - l * sin(q2)      y_pendulum = q1 + l * cos(q2)
    ...
    ylim(ax3, [min(q2U) max(q2U)] + [-0.1 0.1]);
